...
class SimpleClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, hidden_size1, hidden_size2): # 层的个数 和 验证集精度
        # 层初始化
        super(SimpleClassifier, self).__init__()
        self.relu = nn.ReLU()
        self.fc1 = nn.Linear(input_dim, hidden_dim)
        self.fc2 = nn.Linear(hidden_dim, hidden_size1)
...
model = SimpleClassifier(vocab_size, hidden_dim, output_dim, 256, 768) # 维度和精度有什么关系？
